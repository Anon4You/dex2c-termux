...
APKEDITOR = "/data/data/com.termux/files/usr/share/apkeditor/APKEditor.jar"
SIGNJAR = "/data/data/com.termux/files/usr/share/java/apksigner.jar"
...
def sign(unsigned_apk, signed_apk, min_sdk):
    ...
    if (
        ...
        Logger.warning(
            " At least one signing scheme should be enabled from v1, v2 & v3"
        )
